...
export default function SellDemo(){
    return(<>
    <div style={{background: "#FBF7F5",minHeight: "100vh",width: "100%",margin: 0,padding: 0}}>
        <div className="container d-flex gap-7" style={{maxWidth: "1296px", margin: "0 auto"}}>
            <div className="d-flex container row">
                <div className="d-flex flex-column align-items-center p-13 rounded-4 col" style={{background: "white"}}>
                    <h4 className="fw-bold">接案者資訊</h4>
                    <img src="sellDemo-imgs/FriendlyLin.jpg" className="rounded-circle mb-5" style={{width: "80px", height: "80px"}} alt=""/>
                ...
                <div className="col-xxl-9">
                    ...
                    <div className="d-flex flex-column gap-14">
                        <div className="container row d-flex gap-13">
                            ...
                            <div className="col-xxl-5 p-9 rounded-4" style={{background: "white"}}>
                        ...
                        <div>
                        <h3>服務描述</h3>
                            <div className="p-9 rounded-4" style={{background: "white"}}>
                                <p>◆服務​特色​​</p>
        ...
        <div className="container col row justify-content-end my-14">
            <div className="col-xxl-9">
                <h3>評價</h3>
                <div className="mb-5">
                    <div className="py-7 px-9 rounded-4" style={{background: "white"}}>
                        <div className="d-flex justify-content-between">
                            <div className="d-flex gap-3 mb-7">
                                <img className="rounded-circle" src="sellDemo-imgs/Martin.jpg" style={{width: "64px", height: "64px"}} alt="" />
                ...
                <div className="py-7 px-9 rounded-4 mb-5" style={{background: "white"}}>
                    <div className="d-flex justify-content-between">
                        <div className="d-flex gap-3 mb-7">
                            <img className="rounded-circle" src="sellDemo-imgs/Alice.jpg" style={{width: "64px", height: "64px"}} alt="" />
                            <div className="align-self-center">
            ...
            <div className="col-xxl-9 my-15">
                <h3>此用戶還有這些服務...</h3>
                <ul className="list-unstyled d-flex g-5">
                    <li className="col-lg-4 d-flex flex-column rounded-4 align-items-center" style={{background: "white"}}>
                    <div className="p-12">
                        <img src="sellDemo-imgs/graduation.png" className="mb-7 rounded-4" style={{width: "160px", height: "160px"}} alt="" />
                        <h5 className="mb-7 text-center">畢業照拍攝</h5>
                        <button type="button" className="btn btn-secondary-500" style={{width: "160px"}}>前往了解</button> 
                    </div>
                    </li>
                    <li className="col-lg-4 d-flex rounded-4 flex-column align-items-center" style={{background: "white"}}>
                    <div className="p-12">
                        <img src="sellDemo-imgs/pregnant.png" className="mb-7 rounded-4" style={{width: "160px", height: "160px"}} alt="" />
                    ...
                    <li className="col-lg-4 d-flex rounded-4 flex-column align-items-center" style={{background: "white"}}>
                        <div className="p-12">
                            <img src="sellDemo-imgs/company.png" className="mb-7 rounded-4" style={{width: "160px", height: "160px"}} alt="" />
